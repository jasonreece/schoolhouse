<?php
//where the email is going, can be comma-separated for multiple recipients
$to = "info@schoolhousepub.com";
...
if (isset($_POST['submit'])) {
  ...
  //grab POST variables from the form
  $name = $_POST['name'];
  $email = $_POST['email'];
  ...
  $body = "Someone filled out the contact form at Schoolhousepub.com\n";
  $body.= "Name: " . $name . "\n";
  $body.= "Email: " . $email . "\n";
  $body.= "Subject: " . $subject . "\n";
  $body.= "Message: " . $message . "\n";
  
  $subject = "Email From Schoolhousepub.com/"; //the email subject
  $from = $email; //the from address
  $headers = "From:" . $from;
  
  //this line sends mail and saves the result (true/false)
  //in a variable for checking later
  ...
  <body>
    ...
    <main>
      <section class="carousel slide">
        ...
        <?php if ($mail_sent) { ?>
          <div class="js-hero-thank-you l-hero-thank-you">
            <div class="l-hero-thank-you-inner">
              <h1 class="t-hero-thank-you-heading"><span class="t-gs-light u-display-block">YOUR MESSAGE </span>WAS RECEIVED</h1>
            </div>
          </div>
        <?php } ?>
      </section>
